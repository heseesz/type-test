...
const translations = {
  ko: {
    ...
    // SEO Intro Text
    'seo.home.intro': 'Type-Test에 오신 것을 환영합니다! 이곳은 다양한 심리학적 이론과 흥미로운 가치관 질문들을 바탕으로, 나 자신과 상대방의 숨겨진 성향을 알아보는 종합 심리테스트 플랫폼입니다. 친구, 연인과 함께 테스트 결과를 공유하며 서로에 대해 더 깊이 이해하고 즐거운 대화를 나누어 보세요.',
    'seo.balanceGame.desc': "연인, 썸남썸녀, 혹은 친한 친구들과 함께 즐길 수 있는 궁극의 밸런스 게임입니다. 일상적인 연애 가치관을 알아보는 '순한 맛'부터, 숨겨진 본성과 은밀한 취향을 파헤치는 '중간 맛', 그리고 아찔한 수위의 '매운 맛'까지 다양한 난이도의 질문들이 준비되어 있습니다. 서로의 선택을 비교하며 깊은 대화를 나누고, 때로는 열띠게 논쟁하며 서로에 대해 더 깊이 알아가는 시간을 가져보세요. 단순한 킬링타임용 게임을 넘어, 평소에는 묻기 힘들었던 서로의 진짜 속마음과 연애 스타일, 스킨십 성향 등을 자연스럽게 알아볼 수 있는 완벽한 심리적 아이스브레이킹 도구가 되어줄 것입니다. 딜레마에 빠지는 극단적인 상황 속에서 당신은 어떤 선택을 내리게 될까요? 과연 당신과 상대방의 밸런스 일치율은 얼마나 될지, 지금 바로 시작해서 서로의 한계를 테스트해 보세요!",
    'seo.attachment.desc': "존 볼비(John Bowlby)와 메리 애인스워스(Mary Ainsworth)의 발달 심리학적 이론에 기반한 성인 애착 유형 테스트는, 당신이 타인과 관계를 맺고 사랑을 주고받는 방식을 심층적으로 분석합니다. 우리 모두는 어린 시절의 경험과 과거의 인간관계를 통해 자신만의 고유한 애착 패턴을 무의식적으로 형성하게 됩니다. 이 테스트를 통해 당신이 '안정형', '불안-집착형', '회피-거부형', '회피-공포형' 중 어디에 해당하는지 객관적으로 진단해 보세요. 나의 애착 유형을 정확히 파악하는 것은 반복되는 연애의 갈등 원인을 찾고, 더 건강하고 안정적인 대인관계를 구축하는 첫걸음이 됩니다. 나와 상대방의 다름을 논리적으로 이해하고, 내면의 기저에 깔린 불안을 해소하여 성숙한 사랑을 가꾸어 나갈 수 있도록 돕는 심리학적 가이드를 지금 바로 확인해 보시길 바랍니다.",
    'seo.narcissism.desc': "자기애적 성향(Narcissism)은 단순히 자신을 뽐내는 것을 넘어선, 매우 복잡하고 입체적인 심리적 특성입니다. 심리학에서 말하는 나르시시즘은 건강한 자존감의 척도가 되기도 하지만, 때로는 타인과의 관계를 단절시키는 원인이 되기도 합니다. 본 나르시시즘 성향 테스트는 당신의 내면에 숨겨진 자기애의 크기와 형태를 다각도로 측정하여 제공합니다. 타인의 인정과 찬사에 대한 욕구, 대인관계에서의 공감 능력 수준, 무의식적인 특권 의식, 그리고 내면 깊은 곳에 자리 잡은 방어적 취약성까지 꼼꼼하게 분석해 드립니다. 자신이 건강한 형태의 과대형 나르시시스트인지, 아니면 외부의 평가에 상처받기 쉬운 취약형 나르시시스트인지 파악해 보세요. 스스로의 성향을 정면으로 마주하는 것은 자기 객관화를 통해 더 나은 리더십을 발휘하고, 타인과 조화롭게 소통하기 위한 훌륭한 자기계발의 기회가 될 것입니다.",
    'seo.tetoEgen.desc': "테토-에겐 성향 테스트는 연애와 대인관계에서 나타나는 당신의 독특한 행동 패턴과 포지션을 재미있고 예리하게 분석해 주는 인터넷 밈 심리 진단 콘텐츠입니다. 관계를 주도하고 적극적으로 이끌어가는 성향인지, 아니면 상대방의 리드에 부드럽게 맞춰주며 안정감을 제공하는 성향인지 간단히 파악해 봅니다. 당신이 무의식적으로 발산하는 매력 포인트는 무엇이며, 스트레스 상황이나 연인과의 갈등이 발생했을 때 어떤 방식으로 소통하고 대처하는지 등 다채로운 문항을 통해 당신의 캐릭터를 정의해 드립니다. 친구들이나 연인과 함께 결과를 공유하며 서로의 유형이 어떻게 상호작용하고, 어떤 시너지를 낼 수 있는지 비교해 보세요. 나도 몰랐던 나의 모습과 연애 세포를 자극하는 분석 결과를 통해, 관계의 주도권과 긍정적인 소통 방식을 새롭게 돌아볼 수 있는 흥미로운 경험을 선사합니다.",
