...
const translations = {
  ko: {
    ...
    'tests.attachmentTest.title': '성인 애착 유형 테스트',
    'tests.attachmentTest.description': '당신의 애착 유형을 파악하여\n관계 패턴을 이해해보세요',
    'tests.attachmentTest.start': '테스트 시작하기',
    'tests.attachmentTest.meta.title': '타입테스트: 성인 애착 유형 테스트',
    'tests.attachmentTest.meta.description': '과학적 근거에 기반한 애착 이론으로 당신의 관계 패턴을 분석하고 개선 방향을 제시합니다.',
  ...
  en: {
    ...
    'tests.attachmentTest.title': 'Adult Attachment\nStyle Test',
    'tests.attachmentTest.description': 'Understand your relationship patterns\nby discovering your attachment type',
    'tests.attachmentTest.start': 'Start Test',
    'tests.attachmentTest.meta.title': 'TypeTest: Adult Attachment Style Test',
    'tests.attachmentTest.meta.description': 'Discover your attachment style through scientifically-based assessment. Learn about your relationship patterns and get personalized advice for improvement.',
  ...
  es: {
    ...
    'tests.attachmentTest.title': 'Test de Estilo\nde Apego Adulto',
    'tests.attachmentTest.description': 'Entiende tus patrones de relación\ndescubriendo tu tipo de apego',
    'tests.attachmentTest.start': 'Comenzar Test',
    'tests.attachmentTest.meta.title': 'TypeTest: Test de Estilo de Apego Adulto',
    'tests.attachmentTest.meta.description': 'Descubre tu estilo de apego a través de una evaluación basada en evidencia científica. Aprende sobre tus patrones de relación y obtén consejos personalizados.',
