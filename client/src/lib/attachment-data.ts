...
export const attachmentQuestionsEn: AttachmentQuestion[] = [
  // Avoidance items (1-18)
  {
    ...
    answers: [
      { text: "Strongly disagree", avoidanceScore: 2, anxietyScore: 4 },
      { text: "Disagree", avoidanceScore: 3, anxietyScore: 4 },
      { text: "Neutral", avoidanceScore: 4, anxietyScore: 4 },
      { text: "Agree", avoidanceScore: 3, anxietyScore: 4 },
      { text: "Strongly agree", avoidanceScore: 4, anxietyScore: 4 }
    ]
  },
  {
    id: 2,
