...
export const attachmentQuestionsEn: AttachmentQuestion[] = [
  ...
  // Anxiety items (19-36)
  {
    ...
    answers: [
      ...
      { text: "Neutral", avoidanceScore: 0, anxietyScore: 2 },
      { text: "Agree", avoidanceScore: 0, anxietyScore: 3 },
      { text: "Strongly agree", avoidanceScore: 0, anxietyScore: 4 }
    ]
  },
  {
    id: 20,
...
export const attachmentQuestions: AttachmentQuestion[] = [
  // 회피 문항 (1-18)
  {
    ...
    answers: [
      { text: "전혀 동의하지 않음", avoidanceScore: 0, anxietyScore: 0 },
      { text: "동의하지 않음", avoidanceScore: 1, anxietyScore: 0 },
      { text: "보통", avoidanceScore: 2, anxietyScore: 0 },
      { text: "동의함", avoidanceScore: 3, anxietyScore: 0 },
      { text: "매우 동의함", avoidanceScore: 4, anxietyScore: 0 }
    ]
  },
  {
    id: 2,
  ...
  // 불안 문항 (19-36)
  {
    ...
    answers: [
      ...
      { text: "보통", avoidanceScore: 0, anxietyScore: 2 },
      { text: "동의함", avoidanceScore: 0, anxietyScore: 3 },
      { text: "매우 동의함", avoidanceScore: 0, anxietyScore: 4 }
    ]
  },
  {
    id: 20,
...
export const attachmentQuestionsEs: AttachmentQuestion[] = [
  // Avoidance items (1-18)
  {
    ...
    answers: [
      { text: "Totalmente en desacuerdo", avoidanceScore: 0, anxietyScore: 0 },
      { text: "En desacuerdo", avoidanceScore: 1, anxietyScore: 0 },
      { text: "Neutral", avoidanceScore: 2, anxietyScore: 0 },
      { text: "De acuerdo", avoidanceScore: 3, anxietyScore: 0 },
      { text: "Totalmente de acuerdo", avoidanceScore: 4, anxietyScore: 0 }
    ]
  },
  {
    id: 2,
  ...
  // Anxiety items (19-36)
  {
    ...
    answers: [
      ...
      { text: "Neutral", avoidanceScore: 0, anxietyScore: 2 },
      { text: "De acuerdo", avoidanceScore: 0, anxietyScore: 3 },
      { text: "Totalmente de acuerdo", avoidanceScore: 0, anxietyScore: 4 }
    ]
  },
  {
    id: 20,
  ...
  },
  {
    ...
    answers: [
      { text: "Totalmente en desacuerdo", avoidanceScore: 0, anxietyScore: 4 },
      { text: "En desacuerdo", avoidanceScore: 0, anxietyScore: 3 },
      { text: "Neutral", avoidanceScore: 0, anxietyScore: 2 },
      { text: "De acuerdo", avoidanceScore: 0, anxietyScore: 1 },
      { text: "Totalmente de acuerdo", avoidanceScore: 0, anxietyScore: 0 }
    ]
  },
  {
    id: 35,
...
export const attachmentQuestionsJa: AttachmentQuestion[] = [
  // Avoidance items (1-18)
  {
    ...
    answers: [
      { text: "全く同意しない", avoidanceScore: 0, anxietyScore: 0 },
      { text: "同意しない", avoidanceScore: 1, anxietyScore: 0 },
      { text: "どちらでもない", avoidanceScore: 2, anxietyScore: 0 },
      { text: "同意する", avoidanceScore: 3, anxietyScore: 0 },
      { text: "全く同意する", avoidanceScore: 4, anxietyScore: 0 }
    ]
  },
  {
    id: 2,
  ...
  },
  {
    ...
    answers: [
      { text: "全く同意しない", avoidanceScore: 4, anxietyScore: 0 },
      { text: "同意しない", avoidanceScore: 3, anxietyScore: 0 },
      { text: "どちらでもない", avoidanceScore: 2, anxietyScore: 0 },
      { text: "同意する", avoidanceScore: 1, anxietyScore: 0 },
      { text: "全く同意する", avoidanceScore: 0, anxietyScore: 0 }
    ]
  },
  {
    id: 6,
  ...
  // Anxiety items (19-36)
  {
    ...
    answers: [
      ...
      { text: "どちらでもない", avoidanceScore: 0, anxietyScore: 2 },
      { text: "同意する", avoidanceScore: 0, anxietyScore: 3 },
      { text: "全く同意する", avoidanceScore: 0, anxietyScore: 4 }
    ]
  },
  {
    id: 20,
  ...
  },
  {
    ...
    answers: [
      { text: "全く同意しない", avoidanceScore: 0, anxietyScore: 4 },
      { text: "同意しない", avoidanceScore: 0, anxietyScore: 3 },
      { text: "どちらでもない", avoidanceScore: 0, anxietyScore: 2 },
