    ...
    <div className="w-full max-w-2xl mx-auto space-y-6 z-10 relative">
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center mb-2">
          ...
          <span className="text-sm font-extrabold text-indigo-600 dark:text-indigo-400">{currentQuestion + 1} / {shuffledQuestions.length}</span>
        </div>
      ...
      <div className="flex flex-col items-center gap-4 pt-4">
        <div className="flex justify-between items-center w-full gap-4">
          ...
          <Button
            ...
            className="flex-1 py-5 bg-gradient-to-r from-indigo-500 to-purple-500 hover:opacity-90 text-white font-bold rounded-xl shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
          >
