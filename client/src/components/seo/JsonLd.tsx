...
export function WebsiteJsonLd() {
  ...
  const data = {
    ...
    "publisher": {
      ...
      "logo": {
        "@type": "ImageObject",
        "url": "https://type-test.co.kr/favicon.svg",
        "width": 60,
        "height": 60
      },
      "contactPoint": {
    ...
    "potentialAction": {
      ...
      "target": {
        "@type": "EntryPoint",
        "urlTemplate": "https://type-test.co.kr/search?q={search_term_string}"
      },
