    ...
    <div className="w-full max-w-2xl mx-auto space-y-6 z-10 relative">
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center mb-2">
          ...
          <span className="text-sm font-extrabold text-purple-600 dark:text-purple-400">{currentQuestion + 1} / {questions.length}</span>
        </div>
                    ...
                    <Button
                      ...
                      className={`w-full text-left p-4 sm:p-5 md:p-6 h-auto justify-start transition-all duration-300 rounded-xl min-h-[56px] touch-manipulation border-2 ${
                        selectedAnswer === index
                          ? 'bg-purple-50/50 dark:bg-purple-950/20 border-purple-500 dark:border-purple-400 text-purple-700 dark:text-purple-300 shadow-md ring-2 ring-purple-500/20 font-bold'
                          : 'bg-white dark:bg-zinc-800 hover:bg-purple-50/20 dark:hover:bg-purple-950/10 border-zinc-200 dark:border-zinc-850 hover:border-purple-300 dark:hover:border-purple-900 text-zinc-700 dark:text-zinc-300'
                      }`}
                    >
      ...
      <div className="flex flex-col items-center gap-4 pt-4">
        <div className="flex justify-between items-center w-full gap-4">
          ...
          <Button
            ...
            className="flex-1 py-5 bg-gradient-to-r from-purple-500 to-pink-500 hover:opacity-90 text-white font-bold rounded-xl shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
          >
