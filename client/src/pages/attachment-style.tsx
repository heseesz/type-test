...
import { attachmentQuestions, attachmentResults, attachmentQuestionsEn, attachmentResultsEn, attachmentQuestionsEs, attachmentResultsEs } from '@/lib/attachment-data';
...
export default function AttachmentStyle() {
  ...
  const currentQuestions = language === 'en' ? attachmentQuestionsEn : 
                          language === 'es' ? attachmentQuestionsEs : 
                          attachmentQuestions;
  const currentResults = language === 'en' ? attachmentResultsEn : 
                        language === 'es' ? attachmentResultsEs : 
                        attachmentResults;
